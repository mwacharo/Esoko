...
<div class="div_centre">
  ...
  <div class="div_design">
   ...
   <div class="div_design">
    <lable>Product Image here </label><input type="file" class="input_color" name="image" class="input_color" placeholder ="Upload image here" required="">
  </div>
   <div class="div_design">
    <input type="submit" value="Add product" btn btn-primary>
  </div>
  </form>
